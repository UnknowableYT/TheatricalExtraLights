...
### Gobo moving heads
- New **27ch - Profile 16bit** personality on the 8 gobo heads: shutter (0 closed, 1-254 strobe slow to fast, 255 open), 16-bit dimmer, RGB, gobo wheel and rotation, 3-, 6- or 9-facet prism with indexed or continuous rotation, shown in the gobo preview, frost, zoom, focus, 16-bit pan/tilt, pan/tilt speed, framing shutters.
