...
`theatricalextralights:mini_scan_gobo` · family: [Gobo moving heads](/fixtures/gobo-heads)

Small mirror scanner with a gobo wheel. One of the eight gobo heads: it shares the 10ch, 19ch framing shutters and 29ch Profile 16bit personalities and the same rendering engine.
