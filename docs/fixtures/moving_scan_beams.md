...
`theatricalextralights:moving_scan_beams` · family: [Gobo moving heads](/fixtures/gobo-heads)

Scanner body with beam-style gobos. One of the eight gobo heads: it shares the 10ch, 19ch framing shutters and 29ch Profile 16bit personalities and the same rendering engine.
