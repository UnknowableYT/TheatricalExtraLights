...
`theatricalextralights:moving_vl2c_beams` · family: [Gobo moving heads](/fixtures/gobo-heads)

VL2 body with beam-style gobos. One of the eight gobo heads: it shares the 10ch, 19ch framing shutters and 29ch Profile 16bit personalities and the same rendering engine.
