# 9 Waltzes Water Jets (Adjustable)

`theatricalextralights:waltzes_water_jet` · family: [Water jets](/fixtures/water-jets)

Nine swinging jets in a row.

## 3-Channel Mode (labelled 2-Channel Mode) (3 ch)
...
**2 · Tilt** — Base angle of the jets.

**3 · Swing speed** — Speed of the swinging motion, 0 still.
