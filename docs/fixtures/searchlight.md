# Searchlight (7Ch/10Ch)

`theatricalextralights:searchlight` · family: [Moving heads & beams](/fixtures/moving-heads)

Large searchlight on a pan/tilt base, for sky beams.
