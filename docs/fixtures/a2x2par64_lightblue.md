...
`theatricalextralights:a2x2par64_lightblue` · family: [PARs & LED panels](/fixtures/pars-panels)

Block of four PAR 64 cans with a fixed light blue gel, dimmed together.

## 1-Channel Mode (1 ch)

The colour is fixed by the block.
